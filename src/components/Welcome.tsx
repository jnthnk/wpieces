...
const Welcome: FC<WelcomeProps> = () => (
  <header className='relative overflow-hidden px-8 md:px-12 xl:px-16 py-12 md:py-14 xl:py-16 border-b border-gray-500 transition-colors'>
    ...
    <Icon
      name='wordpress'
      className='absolute -top-20 -right-20 z-0 w-72 md:w-80 xl:w-96 fill-gray-200 dark:fill-gray-700 transition-colors'
    />
  </header>
)
